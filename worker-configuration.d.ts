/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings --strict-vars false` (hash: 5c1d1cd43b54f2a87ebade8258f84e8d)
// Runtime types generated with workerd@1.20260128.0 2025-08-03 
declare namespace Cloudflare {
	...
	interface Env {
		...
		ME_EMAIL: string;
		ME_HASH: string;
		ALLOW_RAW_EMAIL: string;
		DEFAULT_SIZE: string;
		MAX_SIZE: string;
		CACHE_TTL_BROWSER: string;
		CACHE_TTL_EDGE: string;
	}
}
