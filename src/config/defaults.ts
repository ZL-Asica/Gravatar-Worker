export const DEFAULT_CONFIG: SiteConfig = {
  branding: {
    ...
    repositoryUrl: 'https://github.com/ZL-Asica/Gravatar-Worker',
    licenseUrl: 'https://github.com/ZL-Asica/Gravatar-Worker/blob/main/LICENSE',
    sourceText: 'Gravatar Worker',
    creditText: 'ZL Asica',
    creditUrl: 'https://zla.pub',
  },
  seo: {
    robotsAllow: true,
